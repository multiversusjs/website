...
export function DocContainer({
	...
	return (
		<div className="flex flex-col min-h-full max-h-full grow">
			<div className="border-0.5 border-transparent px-10 py-2">
			...
			<div className="min-h-full overflow-y-auto overflow-x-clip px-10 pt-5 pb-10">
				<SyntaxHighlighter
					...
					language="typescript"
					style={vscDarkPlus}
					codeTagProps={{ style: { fontFamily: 'SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace' } }}
				>
					{excerpt}
				</SyntaxHighlighter>
